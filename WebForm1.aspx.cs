...
new { m.Title, g.Name }).Skip(1).Take(2);
        ...
        public List<Movie> GetMovies()
        {
            ...
            ReleaseDate=DateTime.Parse("2001/05/16"), RunTime=89 },
            new Movie { Title="Fletch", Director="Michael Ritchie", Genre=0,
            ReleaseDate=DateTime.Parse("1985/05/31"), RunTime=96 },
            new Movie { Title="Casablanca", Director="Michael Curtiz", Genre=1,
            ReleaseDate=DateTime.Parse("1942/01/01"), RunTime=102 },
            new Movie { Title="Batman", Director="Tim Burton", Genre=1,
            ReleaseDate=DateTime.Parse("1989/06/23"), RunTime=126 },
            new Movie { Title="Batman 2", Director="Tim Burton", Genre=0,
            ReleaseDate=DateTime.Parse("1999/06/23"), RunTime=126 }
            };
        }
